...
?>
              ...
              <div class="selection">
                ...
                <form method="post" action="darkmpage.php">
                        <input type="button" value="Spot 4"  id = "button4">
                        <input type="button" value="Spot 1"  id = "button1">
                        <input type="button" value="Spot 5"  id = "button5">
                        <input type="button" value="Spot 2"  id = "button2">
                        <input type="button" value="Spot 6"  id = "button6">
                        <input type="button" value="Spot 3"  id = "button3">
                        
                </form>
                <form method="post" action="darkmpage.php" >

                  <input type="submit"  id="confirmReservation"
